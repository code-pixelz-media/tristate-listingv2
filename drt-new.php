...
<?php
add_shortcode('drt-new', 'drt_shortcode_new');

function drt_shortcode_new($atts)
{
...
?>
<?php
add_action('wp_ajax_live_search', 'live_search_callback_new');
add_action('wp_ajax_nopriv_live_search', 'live_search_callback_new');

function live_search_callback_new()
{
